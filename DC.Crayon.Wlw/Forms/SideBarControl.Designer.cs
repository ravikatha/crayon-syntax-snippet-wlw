namespace DC.Crayon.Wlw.Forms
{
	partial class SideBarControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.urlTextBox = new DC.Crayon.Wlw.CustomTextBox();
			this.urlFieldLabel = new System.Windows.Forms.Label();
			this.codeTextBox = new DC.Crayon.Wlw.CustomTextBox();
			this.codeFieldLabel = new System.Windows.Forms.Label();
			this.markedLinesTextBox = new DC.Crayon.Wlw.CustomTextBox();
			this.markedLinesFieldLabel = new System.Windows.Forms.Label();
			this.lineRangeTextBox = new DC.Crayon.Wlw.CustomTextBox();
			...
			this.titleTextBox = new DC.Crayon.Wlw.CustomTextBox();
